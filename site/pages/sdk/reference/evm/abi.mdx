...
| `sushiSwapV4CLPoolManagerAbi`, `sushiSwapV4CLPoolManagerOwnerAbi`, `sushiSwapV4CLProtocolFeeControllerAbi` | SushiSwap V4 core ABIs. |
| `sushiSwapV4CLPositionDescriptorAbi`, `sushiSwapV4CLPositionManagerAbi`, `sushiSwapV4CLQuoterAbi`, `sushiSwapV4CLTickLensAbi`, `sushiSwapV4VaultAbi` | SushiSwap V4 periphery and vault ABIs. |
