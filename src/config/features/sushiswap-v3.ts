...
> = {
  ...
  [ChainId.SKALE_EUROPA]: '0x51d15889b66A2c919dBbD624d53B47a9E8feC4bB',
  [ChainId.ROOTSTOCK]: '0x46B3fDF7b5CDe91Ac049936bF0bDb12c5d22202e',
  [ChainId.SONIC]: '0x46B3fDF7b5CDe91Ac049936bF0bDb12c5d22202e',
  [ChainId.HEMI]: '0xCdBCd51a5E8728E0AF4895ce5771b7d17fF71959',
} as const
...
> = {
  ...
  [ChainId.SKALE_EUROPA]: POOL_INIT_CODE_HASH,
  [ChainId.ROOTSTOCK]: POOL_INIT_CODE_HASH,
  [ChainId.SONIC]: POOL_INIT_CODE_HASH,
  [ChainId.HEMI]: POOL_INIT_CODE_HASH,
} as const
...
> = {
  ...
  [ChainId.SKALE_EUROPA]: '0xa4d2268f145CD5c835115441b877295C46F25b9b',
  [ChainId.ROOTSTOCK]: '0x0389879e0156033202C44BF784ac18fC02edeE4f',
  [ChainId.SONIC]: '0x0389879e0156033202C44BF784ac18fC02edeE4f',
  [ChainId.HEMI]: '0xe43ca1Dee3F0fc1e2df73A0745674545F11A59F5',
} as const
...
export const SUSHISWAP_V3_TICK_LENS: Record<SushiSwapV3ChainId, `0x${string}`> =
  {
    ...
    [ChainId.SKALE_EUROPA]: '0x65A7158BE70a1270b01713910db7CBfe8d60fF4d',
    [ChainId.ROOTSTOCK]: '0x33d91116e0370970444B0281AB117e161fEbFcdD',
    [ChainId.SONIC]: '0x33d91116e0370970444B0281AB117e161fEbFcdD',
    [ChainId.HEMI]: '0x1f2FCf1d036b375b384012e61D3AA33F8C256bbE',
  } as const
