...
// SUSHISWAP
export const SUSHISWAP_V3_FACTORY_ADDRESS: Record<SushiSwapV3ChainId | DeprecatedSushiSwapV3ChainId, Address> =
  {
...
export const SUSHISWAP_V3_INIT_CODE_HASH: Record<SushiSwapV3ChainId | DeprecatedSushiSwapV3ChainId, Address> =
  {
...
export const SUSHISWAP_V3_TICK_LENS: Record<SushiSwapV3ChainId | DeprecatedSushiSwapV3ChainId, Address> = {
...
export const isDeprecatedSushiSwapV3ChainId = (
  ...
  DEPRECATED_SUSHISWAP_V3_CHAIN_IDS.includes(chainId as DeprecatedSushiSwapV3ChainId)
