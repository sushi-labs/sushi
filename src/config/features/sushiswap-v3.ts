...
// SUSHISWAP
export const SUSHISWAP_V3_FACTORY_ADDRESS: Record<SushiSwapV3ChainId, Address> =
  {
...
export const SUSHISWAP_V3_INIT_CODE_HASH: Record<SushiSwapV3ChainId, Address> =
  {
...
export const SUSHISWAP_V3_TICK_LENS: Record<SushiSwapV3ChainId, Address> = {
...
export const sushiSwapV3ChainIdSet = new Set(SUSHISWAP_V3_SUPPORTED_CHAIN_IDS)

export const isSushiSwapV3ChainId = (
  chainId: EvmChainId,
): chainId is SushiSwapV3ChainId =>
  sushiSwapV3ChainIdSet.has(chainId as SushiSwapV3ChainId)
