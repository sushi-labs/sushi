...
export const USDT = {
  ...
  [EvmChainId.BSC_TESTNET]: createEvmToken({
  ...
  [EvmChainId.ROOTSTOCK]: createEvmToken({
...
export const STARGATE_USDT = {
  [EvmChainId.FANTOM]: createEvmToken({
  ...
  [EvmChainId.KAVA]: createEvmToken({
