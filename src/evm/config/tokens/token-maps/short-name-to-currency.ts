...
const CHAIN_ID_SHORT_CURRENCY_NAME_TO_CURRENCY = {
  [EvmChainId.ARBITRUM]: {
    ETH: EvmNative.fromChainId(EvmChainId.ARBITRUM),
  ...
  [EvmChainId.BOBA]: {
    ETH: EvmNative.fromChainId(EvmChainId.BOBA),
    WETH: WNATIVE[EvmChainId.BOBA],
    SUSHI: SUSHI[EvmChainId.BOBA],
  },
  [EvmChainId.BOBA_BNB]: {
    BOBA: EvmNative.fromChainId(EvmChainId.BOBA_BNB),
  ...
  [EvmChainId.BSC]: {
    // NATIVE: EvmNative.fromChainId(EvmChainId.BSC),
    // WNATIVE: WNATIVE[EvmChainId.BSC],
    BNB: EvmNative.fromChainId(EvmChainId.BSC),
  ...
  [EvmChainId.BTTC]: {
    BTT: EvmNative.fromChainId(EvmChainId.BTTC),
    WBTT: WNATIVE[EvmChainId.BTTC],
    SUSHI: SUSHI[EvmChainId.BTTC],
  },
  [EvmChainId.CELO]: {
    CELO: EvmNative.fromChainId(EvmChainId.CELO),
    WCELO: WNATIVE[EvmChainId.CELO],
    SUSHI: SUSHI[EvmChainId.CELO],
    AGEUR: AGEUR[EvmChainId.CELO],
  },
  [EvmChainId.ETHEREUM]: {
    // NATIVE: EvmNative.fromChainId(EvmChainId.ETHEREUM),
    // WNATIVE: WETH9[EvmChainId.ETHEREUM],
    ETH: EvmNative.fromChainId(EvmChainId.ETHEREUM),
  ...
  [EvmChainId.FANTOM]: {
    // NATIVE: EvmNative.fromChainId(EvmChainId.FANTOM),
    // WNATIVE: WNATIVE[EvmChainId.FANTOM],
    FTM: EvmNative.fromChainId(EvmChainId.FANTOM),
  ...
  [EvmChainId.POLYGON]: {
    // NATIVE: EvmNative.fromChainId(EvmChainId.POLYGON),
    // WNATIVE: WNATIVE[EvmChainId.POLYGON],
    MATIC: EvmNative.fromChainId(EvmChainId.POLYGON),
  ...
  [EvmChainId.POLYGON_ZKEVM]: {
    ...
    ETH: EvmNative.fromChainId(EvmChainId.POLYGON_ZKEVM),
    WETH: WNATIVE[EvmChainId.POLYGON_ZKEVM],
  },
  [EvmChainId.CORE]: {
    NATIVE: EvmNative.fromChainId(EvmChainId.CORE),
    WNATIVE: WNATIVE[EvmChainId.CORE],
    ETH: WETH9[EvmChainId.CORE],
    WETH: WETH9[EvmChainId.CORE],
  },
  [EvmChainId.HAQQ]: {
    NATIVE: EvmNative.fromChainId(EvmChainId.HAQQ),
    WNATIVE: WNATIVE[EvmChainId.HAQQ],
    ETH: WETH9[EvmChainId.HAQQ],
    WETH: WETH9[EvmChainId.HAQQ],
  },
  [EvmChainId.ZKSYNC_ERA]: {
    NATIVE: EvmNative.fromChainId(EvmChainId.ZKSYNC_ERA),
    WNATIVE: WNATIVE[EvmChainId.ZKSYNC_ERA],
    ETH: EvmNative.fromChainId(EvmChainId.ZKSYNC_ERA),
    WETH: WNATIVE[EvmChainId.ZKSYNC_ERA],
  },
  [EvmChainId.LINEA]: {
    NATIVE: EvmNative.fromChainId(EvmChainId.LINEA),
    WNATIVE: WNATIVE[EvmChainId.LINEA],
    ETH: EvmNative.fromChainId(EvmChainId.LINEA),
    WETH: WNATIVE[EvmChainId.LINEA],
  },
  [EvmChainId.BASE]: {
    NATIVE: EvmNative.fromChainId(EvmChainId.BASE),
    WNATIVE: WNATIVE[EvmChainId.BASE],
    ETH: EvmNative.fromChainId(EvmChainId.BASE),
    WETH: WNATIVE[EvmChainId.BASE],
  },
  [EvmChainId.SCROLL]: {
    NATIVE: EvmNative.fromChainId(EvmChainId.SCROLL),
    WNATIVE: WNATIVE[EvmChainId.SCROLL],
    ETH: EvmNative.fromChainId(EvmChainId.SCROLL),
    WETH: WNATIVE[EvmChainId.SCROLL],
  },
  [EvmChainId.FILECOIN]: {
    NATIVE: EvmNative.fromChainId(EvmChainId.FILECOIN),
    WNATIVE: WNATIVE[EvmChainId.FILECOIN],
  },
  [EvmChainId.ZETACHAIN]: {
    NATIVE: EvmNative.fromChainId(EvmChainId.ZETACHAIN),
    WNATIVE: WNATIVE[EvmChainId.ZETACHAIN],
  },
  [EvmChainId.BLAST]: {
    NATIVE: EvmNative.fromChainId(EvmChainId.BLAST),
  ...
  [EvmChainId.ROOTSTOCK]: {
    NATIVE: EvmNative.fromChainId(EvmChainId.ROOTSTOCK),
...
>>>>>>> d208e4475352fb6fa2bde4ed5d94ca6c6b05b4cc
  },
} as const
