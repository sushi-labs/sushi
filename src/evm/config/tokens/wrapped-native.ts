...
import { createEvmToken, type EvmToken } from '~evm/currency/token.js'
...
export const WNATIVE = {
  ...
  [EvmChainId.FANTOM_TESTNET]: createEvmToken({
  ...
  [EvmChainId.POLYGON]: createEvmToken({
  ...
  [EvmChainId.GNOSIS]: createEvmToken({
  ...
  [EvmChainId.AVALANCHE]: createEvmToken({
  ...
  [EvmChainId.HARMONY]: createEvmToken({
  ...
  [EvmChainId.CELO]: createEvmToken({
  ...
  [EvmChainId.METIS]: createEvmToken({
  ...
  [EvmChainId.BTTC]: createEvmToken({
  ...
  [EvmChainId.THUNDERCORE]: createEvmToken({
  ...
  [EvmChainId.HAQQ]: createEvmToken({
  ...
  [EvmChainId.CORE]: createEvmToken({
  ...
  [EvmChainId.FILECOIN]: createEvmToken({
  ...
  [EvmChainId.ZETACHAIN]: createEvmToken({
  ...
  [EvmChainId.CRONOS]: createEvmToken({
  ...
  [EvmChainId.SKALE_EUROPA]: createEvmToken({
  ...
  [EvmChainId.MANTLE]: createEvmToken({
  ...
  [EvmChainId.CURTIS]: createEvmToken({
  ...
  [EvmChainId.SONIC]: createEvmToken({
