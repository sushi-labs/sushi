...
export interface CollectOptions {
   ...
   */
  expectedCurrencyOwed0: Amount<EvmCurrency>

  /**
   * Expected value of tokensOwed1, including as-of-yet-unaccounted-for fees/liquidity value to be burned
   */
  expectedCurrencyOwed1: Amount<EvmCurrency>
...
export abstract class NonfungiblePositionManager {
  ...
  public static addCallParameters(
    ...
    if (options.useNative) {
      ...
      invariant(
        position.pool.token0.isSame(wrapped) ||
          position.pool.token1.isSame(wrapped),
        'NO_WETH',
      )
      ...
      if (involvesETH) {
        ...
        const token =
          options.expectedCurrencyOwed0.currency.type === 'native'
            ...
            : (options.expectedCurrencyOwed0.currency as EvmToken)
        const tokenAmount =
          options.expectedCurrencyOwed0.currency.type === 'native'
            ? options.expectedCurrencyOwed1.amount
            : options.expectedCurrencyOwed0.amount
      ...
      ...NonfungiblePositionManager.encodeCollect([
        {
          ...
          expectedCurrencyOwed0: expectedCurrencyOwed0.add(
            new Amount(expectedCurrencyOwed0.currency, amount0Min),
          ),
          expectedCurrencyOwed1: expectedCurrencyOwed1.add(
            new Amount(expectedCurrencyOwed1.currency, amount1Min),
          ),
          ...rest,
        },
      ]),
